			...
			<div class="main-content">		
              ...
              <div class="live-market">
                 <h3><span><?php echo $_GET['method']; ?></span> </h3>
                        <div class="bull">
                                  <a href="#"><img src="./view/images/<?php echo $data[2][0]->article_picture; ?>" alt="" /></a>
                        </div>
                        <div class="bull-text">
                                <a class="bull1" href="#"><?php echo $data[2][0]->article_title; ?></a>
                                <p><?php echo $data[2][0]->article_subtitle; ?></p>
                        </div>
                        <div class="clearfix"></div>
						<br>
                        <?php echo substr($data[2][0]->article_intro_text,0,300); ?> 
                </div>
						  ...
						  <div class="sports-top">
							<div class="s-grid-left">
								...
								<div class="sc-image">   
                                    ...
                                    <?php } ?>
                                   <br>                      
                                 <div style="float:right;border:1px solid red; padding:0 5px "><a href="#">More  +</a></div>
									</div>
								</div>
								...
								<div class="cricket">
									...
									<div class="s-grid-small">
											...
											<div class="c-text">
												<p><?php echo $article->article_time; ?></p>
											<a class="power" href="#"><?php echo $article->article_title; ?></a>
											<a class="reu" href="#"><?php echo substr($article->article_intro_text,0,90); ?>...</a> 
											</div>
											<div class="clearfix"></div>
										</div>
										<?php }?>
