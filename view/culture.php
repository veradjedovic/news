			...
			<div class="main-content">		
				<div class="col-md-9 total-news">
                 ...
                 <div class="live-market">
                        ...
                        <div class="bull">
                                <a href="#"><img src="./view/images/<?php echo $data[4][0]->article_picture; ?>" alt="" /></a>
                        </div>
                        <div class="bull-text">
                             <a class="bull1" href="#"><?php echo $data[4][0]->article_title; ?></a>
                                <p><?php echo $data[4][0]->article_subtitle; ?></p>  
                        </div>
                        <div class="clearfix"></div>
						<br>
                        <?php echo substr($data[4][0]->article_intro_text,0,300); ?>
                </div>
